...
| <a name="input_iampolicy_json_content"></a> [iampolicy\_json\_content](#input\_iampolicy\_json\_content) | Custom IAM Policy for EFS CSI Driver IRSA | `string` | `null` | no |
...
| Name | Description |
|------|-------------|
| <a name="output_chart_version"></a> [chart\_version](#output\_chart\_version) | The Helm chart version that is deployed. |
| <a name="output_iam_policy"></a> [iam\_policy](#output\_iam\_policy) | The IAM policy name generated using the module name and EKS cluster name. |
| <a name="output_namespace"></a> [namespace](#output\_namespace) | The Kubernetes namespace where the Helm release is deployed. |
| <a name="output_repository"></a> [repository](#output\_repository) | The Helm chart repository URL used for deployment. |
| <a name="output_service_account"></a> [service\_account](#output\_service\_account) | The Kubernetes service account name created for the Helm deployment. |
<!-- END_TF_DOCS -->