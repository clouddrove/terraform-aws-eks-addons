...
| <a name="input_externalsecrets_manifests"></a> [externalsecrets\_manifests](#input\_externalsecrets\_manifests) | n/a | <pre>object({<br>    secret_store_manifest_file_path     = string<br>    external_secrets_manifest_file_path = string<br>    secret_manager_name                 = string<br>  })</pre> | n/a | yes |
...
| <a name="output_secret_manager_name"></a> [secret\_manager\_name](#output\_secret\_manager\_name) | n/a |
