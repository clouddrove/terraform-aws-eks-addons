...
| <a name="input_iampolicy_json_content"></a> [iampolicy\_json\_content](#input\_iampolicy\_json\_content) | Custom IAM Policy for EBS CSI Driver IRSA | `string` | `null` | no |
...
| <a name="output_iam_policy"></a> [iam\_policy](#output\_iam\_policy) | The IAM policy name created for the service account, associated with the specified EKS cluster. |
