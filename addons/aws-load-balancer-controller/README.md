...
| [terraform_data.vpc_id](https://registry.terraform.io/providers/hashicorp/terraform/latest/docs/resources/data) | resource |
...
| <a name="output_repository"></a> [repository](#output\_repository) | The Helm chart repository URL used for fetching the chart. |
