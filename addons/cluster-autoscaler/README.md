...
| <a name="input_iampolicy_json_content"></a> [iampolicy\_json\_content](#input\_iampolicy\_json\_content) | Custom IAM Policy for ClusterAutoscaler IRSA | `string` | `null` | no |
...
| <a name="output_service_account"></a> [service\_account](#output\_service\_account) | The name of the Kubernetes service account created by this module. |
<!-- END_TF_DOCS -->